...
public class UsurpedCupidon implements UsurpedPower {
    ...
    // Appelé après chaque échange de commande (switch) : si une marque Amour a
    // changé de propriétaire, notifie le Sosie (qui ne connaît pas qui l'a perdue).
    ...
    public void saveState(com.google.gson.JsonObject obj) {
        ...
        // reconnexion (onEnter), conformément au comportement du vrai Cupidon.
    }
