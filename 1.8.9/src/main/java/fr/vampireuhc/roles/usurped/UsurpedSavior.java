...
public class UsurpedSavior implements UsurpedPower {
    ...
    // Salvatrice copiée par le Sosie : la pose de la marque est identique
    // (marqueur SALVATION_DOPPELGANGER neutre), mais le blocage d'une marque
    // maître/vampire n'est que partiel (50%) : la décision est prise dans
    // MarkerManager.tryApplyMark sur la variante DOPPELGANGER.
