...
/**
 * Comte usurpé : le Sosie gagne le pouvoir passif du Comte (dénombrement des
 * auras lumineuses dans un rayon de 50 blocs à chaque début d'épisode, en
 * message privé) ainsi que tout le pouvoir du Sbire usurpé (buffs vampires +
 * vote). Comme pour le Sbire, il ne connaît ni le résultat du vote ni les
 * autres vampires.
 */
public class UsurpedComte extends UsurpedVampire {
    ...
    private void scanLuminousAuras() {
        ...
        bukkitComte.sendMessage(MessageUtil.info(
                "<gold>Auras lumineuses autour de vous : <white>" + luminous + "</white> dans un rayon de 50 blocs.</gold>"));
    }
}