...
/**
 * Gremlin usurpé (26.2) : le switch est imparfait — un seul marqueur aléatoire
 * de chaque joueur est échangé (pas l'ensemble). Le drain est copié
 * exactement (30% de chance de voler un demi-cœur par coup pendant 5 minutes,
 * puis un poison léger). Gates propres au Sosie.
 */
    ...
    public boolean activateDrain(int currentEpisode) {
        ...
        this.drainTask = Bukkit.getScheduler().runTaskLater(VampireUHC.getInstance(), () -> {
            ...
            if (player != null && player.isOnline() && player.isValid()) {
                player.sendActionBar(MessageUtil.actionBar(
