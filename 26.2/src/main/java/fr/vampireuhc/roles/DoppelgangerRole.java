...
/**
 * Doppelganger : rôle solitaire qui copie, une seule fois entre
 ...
 * source = le Doppelganger) et n'hérite jamais de l'état accumulé par la cible :
 * chaque pouvoir copié embarque ses propres compteurs, nets et gates.
 *
 * Règles (doc/Doppelganger.md) :
 *  - la cible doit être vivante et connectée, jamais un autre Doppelganger ;
 *  - mort de l'usurpé : perte immédiate des pouvoirs et des marqueurs posés
 *    par le Doppelganger, apprentissage de l'identité du tueur (si identifié, et
 *    s'il ne s'agit pas de lui) et +50% de dégâts permanents contre ce tueur ;
 *  - si le Doppelganger tue ensuite ce tueur : force + speed permanents ;
...
public class DoppelgangerRole implements Role {
    ...
    private boolean killerKilled = false;      // tueur tué par le Doppelganger → force + speed permanents
     ...
     * vérifiée par canUsurp, cible vivante/connectée/pas un Doppelganger) puis
     ...
     *  - mort du tueur → si le Doppelganger l'a tué : force + speed permanents.
     */
    @Override
    ...
    private void onUsurpedDeath(VampireUHCPlayer killerVp) {
        ...
        // Les marqueurs posés PAR LE Doppelganger (variantes DOPPELGANGER) s'estompent.
    ...
    /** Le Doppelganger a tué le tueur de sa cible : force + speed permanents. */
