...
public class ConfigManager {
    ...
    public double getAppleDropChance() {
        return cfg().getDouble("gameplay.apple-drop-chance", 0.5);
    }

    public int getLeatherBonus() {
        return cfg().getInt("gameplay.leather-bonus", 5);
    }
